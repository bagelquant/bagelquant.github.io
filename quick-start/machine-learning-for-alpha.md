...
permalink: /quick-start/machine-learning-for-alpha/
---
...
Begin with strong linear baselines, then add more flexible models only when the research question justifies them. See [Machine Learning Models](/learn/models/machine-learning/).
