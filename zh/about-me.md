...
> 本页是 [/about-me/](/about-me/) 的中文版本。专有名词和代码标识保持英文，以便和包 API 对齐。
...
* 组合 construction under realistic trading constraints
...
* 因子 design and cross-sectional signal evaluation
...
* Analyst–Management Disagreement (RA, Rutgers)
    NLP-based analysis of earnings calls to measure disagreement and link to market reactions.
* Volatility Forecasting & Risk Timing
    GARCH and LSTM models for volatility prediction and portfolio risk timing.
