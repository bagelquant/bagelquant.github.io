...
A small, pandas-first toolkit for **single-factor evaluation/testing**. You can find a quick guide on how to evaluate factor in this post: [How to evaluate factor using bagel-factor package](https://bagelquant.com/how-to-evaluate-factors/).
